    ...
    public partial class BankContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Administrator>(entity =>
            {
                ...
                entity.Property(e => e.AdminType).HasMaxLength(50).IsUnicode(false);

                entity.Property(e => e.Email).HasMaxLength(50).IsUnicode(false);

                entity.Property(e => e.Name).HasMaxLength(200).IsUnicode(false);

                entity.Property(e => e.PhoneNumber).HasMaxLength(40).IsUnicode(false);

                entity.Property(e => e.Pwd).HasMaxLength(50).IsUnicode(false);
            ...
            modelBuilder.Entity<BankTransaction>(entity =>
            {
                ...
                entity
                    .HasOne(d => d.TransactionTypeNavigation)
                    .WithMany(p => p.BankTransactions)
